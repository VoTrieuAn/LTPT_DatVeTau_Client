...
public class ThemLichTrinhController {
    ...
    @FXML
    private DatePicker ngayKT_DatePicker;
    ...
    @FXML
    private ComboBox<Integer> cboxGioKH;

    @FXML
    private ComboBox<Integer> cboxGioKT;

    @FXML
    private ComboBox<Integer> cboxPhutKH;

    @FXML
    private ComboBox<Integer> cboxPhutKT;

    @FXML
    private ComboBox<String> cboxGaKetThuc;

    @FXML
    private ComboBox<String> cboxGaKhoiHanh;

    @FXML
    private ComboBox<String> cboxTau;

    @FXML
    private TableColumn<LichTrinh, String> gaKHColumn;

    @FXML
    private TableColumn<LichTrinh, String> gaKTColumn;

    @FXML
    private TableColumn<LichTrinh, String> gioKHColumn;

    @FXML
    private TableColumn<LichTrinh, LocalTime> gioKTColumn;

    @FXML
    private Label labelDanhSachLT;
    ...
    @FXML
    private TableColumn<LichTrinh, LocalDate> ngayKHColumn;

    @FXML
    private DatePicker ngayKH_DatePicker;

    @FXML
    private TableColumn<LichTrinh, LocalDate> ngayKTColumn;

    @FXML
    private TableView<LichTrinh> tableThemLT;

    @FXML
    private TableColumn<LichTrinh, String> trangThaiColumn;
    @FXML
...
//            gaTheoLichTrinhList.forEach(x -> System.out.println(x));
    ...
    private List<LichTrinh> taoDanhSachLichTrinh(List<String> list) {
        ...
        String maTau = cboxTau.getValue();
        Tau tauByMa = taudao.timKiemId(maTau);
    ...
    private void luuLai(){
        ...
        if (!lichTrinhList.isEmpty()) {
            ...
            try {
                ...
                LichTrinhDAO lichTrinhDAO = databaseContext.newEntityDAO(LichTrinhDAO.class);

                // Lưu từng Lịch Trình vào database
                for (LichTrinh lichTrinh : lichTrinhList) {
                    lichTrinhDAO.them(lichTrinh); // phương thức thêm một lịch trình
                }
                ...
                // Hiển thị thông báo lỗi nếu gặp sự cố khi lưu
